...
export default function Index() {
  ...
  const reviews = [
    { id: 1, name: 'Покупатель', text: 'Очень довольна покупкой! Книги пришли быстро, упакованы отлично. Качество на высоте, цены приятно радуют. Спасибо большое!', rating: 5 },
    { id: 2, name: 'Постоянный клиент', text: 'Заказываю книги уже не первый раз. Всегда внимательное отношение, помогают с выбором. Большой ассортимент советской литературы!', rating: 5 },
    { id: 3, name: 'Любитель книг', text: 'Отличный магазин! Нашел редкие издания детской литературы для коллекции. Состояние книг соответствует описанию, цены очень доступные.', rating: 5 },
    { id: 4, name: 'Благодарный покупатель', text: 'Приобрел несколько томов классики. Упаковка надежная, доставка быстрая. Рекомендую всем любителям советских книг!', rating: 5 },
    { id: 5, name: 'Читатель', text: 'Замечательный выбор зарубежной литературы советского периода. Книги в хорошем состоянии, приятные цены. Обязательно вернусь за новыми покупками!', rating: 5 },
    { id: 6, name: 'Коллекционер', text: 'Спасибо за бережное отношение к книгам! Нашел несколько раритетов для своей коллекции. Продавец всегда на связи, отвечает на все вопросы.', rating: 5 },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-[#3E2723]/80 text-lg leading-relaxed">
                <p>
                  «Магазин Старой Книги» — это семейный букинистический магазин с более чем 13-летней историей. 
                  Мы специализируемся на советских книгах: огромный выбор детской литературы, русская советская литература, зарубежная литература советского периода, русская классика и многое другое.
                </p>
                <p>
                  Мы бережно собираем книги для Вас и предлагаем <strong className="text-[#8B4513] font-bold">очень доступные цены</strong>.
                </p>
                <div className="flex gap-4 pt-4">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#8B4513]">13+</div>
                  ...
                  <div className="text-center">
                    <div className="text-4xl font-bold text-[#8B4513]">💰</div>
                    <div className="text-sm text-[#3E2723]/60">низкие цены</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="reviews" className="py-16 px-4 bg-[#FFF8DC]/50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mt-8">
            <Button 
              variant="outline"
              className="border-2 border-[#8B4513] text-[#8B4513] hover:bg-[#8B4513] hover:text-[#FFF8DC]"
              onClick={() => window.open('https://vk.com/topic-54037046_35256101', '_blank')}
            >
              Все отзывы в группе ВК
